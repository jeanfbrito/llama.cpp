...
// TurboQuant 3-bit: WHT + PolarQuant (3.5 bpv, 4.6x compression vs fp16)
...
// TurboQuant 4-bit: 4-bit PolarQuant indices (68 bytes per 128 values)
...
// TurboQuant 2-bit: WHT + 2-bit PolarQuant (2.0625 bpv, 7.8x compression vs fp16)
